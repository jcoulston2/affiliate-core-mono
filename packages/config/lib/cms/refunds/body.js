  ...
  cards: [
    {
      ...
      copy: {
        text:
          'We make it easy to search thousands of your favourite outfits from all of your favourite brands. Plus, keep up to date with all the latest fashion trends',
        tag: 'p',
